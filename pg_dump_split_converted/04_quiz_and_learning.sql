...
CREATE TABLE IF NOT EXISTS public.ba_knowledge_questions (
    id integer NOT NULL,
    category text NOT NULL,
...
CREATE SEQUENCE IF NOT EXISTS public.ba_knowledge_questions_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE SEQUENCE IF NOT EXISTS public.quiz_responses_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE SEQUENCE IF NOT EXISTS public.user_mastery_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
INSERT INTO public.quiz_questions (id, category, topic, difficulty, question_text, option_a, option_b, option_c, option_d, correct_answer, question_type, explanation, created_at) VALUES
...
INSERT INTO public.quiz_attempts (id, thread_id, total_questions, correct_answers, score_percentage, time_spent, created_at, topic, category, points_earned) VALUES
('2', NULL, '10', '6', '60', NULL, '2025-10-30 07:50:13.012956', 'Order Flow Fundamentals', 'Order Management', '60'),
('3', NULL, '10', '7', '70', NULL, '2025-10-30 08:18:39.204116', 'Order Flow Fundamentals', 'Order Management', '70'),
('4', NULL, '10', '7', '70', NULL, '2025-10-30 08:20:57.688852', 'Partial Confirmations & Status', 'Order Management', '70'),
('5', NULL, '10', '1', '10', NULL, '2025-10-31 07:09:30.832359', 'Order Capture & Document Validation', 'Order Management', '10'),
('6', NULL, '10', '5', '50', NULL, '2025-12-15 08:32:03.772973', 'Order Flow Fundamentals', 'Order Management', '50');

INSERT INTO public.user_mastery (id, overall_score, current_level, quiz_performance_score, topic_coverage_score, retention_score, topics_mastered, total_quizzes_taken, updated_at, total_cumulative_points) VALUES
('1', '43', 'Intermediate', '260', '0', '0', '2', '5', '2025-12-15 08:32:03.97', '260');

INSERT INTO public.ba_knowledge_questions (id, category, question, is_active, created_at) VALUES
('1', 'Product Overview', 'What are the core modules of the WealthForce platform and how do they interact?', false, '2025-12-17 11:07:01.710924'),
('2', 'Product Overview', 'Which user personas are supported and what are their primary workflows?', false, '2025-12-17 11:07:01.948013'),
('3', 'Product Overview', 'What key business problems does the product solve for wealth managers and advisors?', false, '2025-12-17 11:07:02.182558'),
('4', 'Product Overview', 'What asset classes and investment products are supported end to end?', false, '2025-12-17 11:07:02.530147'),
('5', 'Product Overview', 'What are the major product limitations or exclusions we should know?', false, '2025-12-17 11:07:02.763233'),
('6', 'Customer Lifecycle', 'How does the client onboarding journey flow from lead to funded account?', false, '2025-12-17 11:07:02.999312'),
('7', 'Customer Lifecycle', 'What are the steps and approvals in the KYC/AML process?', false, '2025-12-17 11:07:03.233992'),
('8', 'Customer Lifecycle', 'How are client consent and document signatures captured and stored?', false, '2025-12-17 11:07:03.468905'),
('9', 'Customer Lifecycle', 'How does the system manage updates to client profiles and periodic reviews?', false, '2025-12-17 11:07:03.702183'),
('10', 'Customer Lifecycle', 'How does offboarding or account closure work and what data is retained?', false, '2025-12-17 11:07:03.936669'),
('11', 'Accounts & Profiles', 'What account types are supported (individual, joint, HUF, corporate, trust)?', false, '2025-12-17 11:07:04.171882'),
('12', 'Accounts & Profiles', 'How are risk profiles captured, scored, and versioned over time?', false, '2025-12-17 11:07:04.410652'),
('13', 'Accounts & Profiles', 'How are investment goals modeled and linked to portfolios?', false, '2025-12-17 11:07:04.681721'),
('14', 'Accounts & Profiles', 'How are beneficiaries and nominees managed?', false, '2025-12-17 11:07:04.984852'),
('15', 'Accounts & Profiles', 'How are fees, tax status, and residency attributes stored and applied?', false, '2025-12-17 11:07:05.293241'),
('16', 'Orders & Transactions', 'What is the full order lifecycle from placement to settlement?', false, '2025-12-17 11:07:05.60034'),
('17', 'Orders & Transactions', 'How does the system handle SIP, SWP, and STP scheduling and failures?', false, '2025-12-17 11:07:05.90875'),
('18', 'Orders & Transactions', 'How are NAV cutoffs, pricing dates, and holidays handled?', false, '2025-12-17 11:07:06.21568'),
('19', 'Orders & Transactions', 'How are corporate actions (dividends, splits) reflected in holdings?', false, '2025-12-17 11:07:06.521697'),
('20', 'Orders & Transactions', 'What reconciliation steps exist for failed or reversed transactions?', false, '2025-12-17 11:07:07.058413'),
('21', 'Portfolio & Advisory', 'How does portfolio construction and rebalancing work?', false, '2025-12-17 11:07:07.292874'),
('22', 'Portfolio & Advisory', 'What suitability checks are enforced before recommendations?', false, '2025-12-17 11:07:07.527008'),
('23', 'Portfolio & Advisory', 'How are model portfolios defined and customized per client?', false, '2025-12-17 11:07:07.761261'),
('24', 'Portfolio & Advisory', 'How are advisory notes and rationale stored alongside recommendations?', false, '2025-12-17 11:07:07.995729'),
('25', 'Portfolio & Advisory', 'How does the system track performance vs benchmark?', false, '2025-12-17 11:07:08.230067'),
('26', 'Reporting & Analytics', 'What standard client reports are available out of the box?', false, '2025-12-17 11:07:08.463284'),
('27', 'Reporting & Analytics', 'How are performance metrics (IRR, XIRR, TWR) calculated?', false, '2025-12-17 11:07:08.697648'),
('28', 'Reporting & Analytics', 'What analytics are available for RM productivity and pipeline?', false, '2025-12-17 11:07:09.04121'),
('29', 'Reporting & Analytics', 'How does the system generate regulatory or tax reports?', false, '2025-12-17 11:07:09.275909'),
('30', 'Reporting & Analytics', 'What report scheduling and distribution options exist?', false, '2025-12-17 11:07:09.59035'),
('31', 'Compliance & Risk', 'What regulatory rules (SEBI, AMFI, FINRA) are encoded in the product?', false, '2025-12-17 11:07:09.894129'),
('63', 'Compliance & Risk', 'How are compliance breaches detected, logged, and escalated?', false, '2025-12-17 11:07:44.273866'),
('64', 'Compliance & Risk', 'What audit trails are maintained for advisory and order actions?', false, '2025-12-17 11:07:44.512235'),
('65', 'Compliance & Risk', 'How are conflict-of-interest checks handled?', false, '2025-12-17 11:07:44.823396'),
('66', 'Compliance & Risk', 'How are risk limits and concentration constraints enforced?', false, '2025-12-17 11:07:45.060611'),
('67', 'Data & Integrations', 'What core integrations exist (custodian, AMC, market data, CRM)?', false, '2025-12-17 11:07:45.299437'),
('68', 'Data & Integrations', 'What APIs are exposed for third-party integrations?', false, '2025-12-17 11:07:45.543559'),
('69', 'Data & Integrations', 'How is data synchronized and what is the refresh frequency?', false, '2025-12-17 11:07:45.7818'),
('70', 'Data & Integrations', 'How are master data changes governed and versioned?', false, '2025-12-17 11:07:46.018917'),
('71', 'Data & Integrations', 'What is the data model for holdings, transactions, and valuations?', false, '2025-12-17 11:07:46.256103'),
('72', 'Operations & Support', 'What operational dashboards exist for exception handling?', false, '2025-12-17 11:07:46.494688'),
('73', 'Operations & Support', 'How are service requests and tickets tracked?', false, '2025-12-17 11:07:46.731864'),
('74', 'Operations & Support', 'What batch jobs run daily and what are their SLAs?', false, '2025-12-17 11:07:46.969056'),
('75', 'Operations & Support', 'How are errors, retries, and compensating actions managed?', false, '2025-12-17 11:07:47.206261'),
('76', 'Operations & Support', 'What is the process for release management and feature toggles?', false, '2025-12-17 11:07:47.444861'),
('77', 'Security & Access', 'What authentication mechanisms are supported (SSO, MFA)?', false, '2025-12-17 11:07:47.685426'),
('78', 'Security & Access', 'How is role-based access control structured across teams?', false, '2025-12-17 11:07:47.94928'),
('79', 'Security & Access', 'How is sensitive data encrypted at rest and in transit?', false, '2025-12-17 11:07:48.192149'),
('80', 'Security & Access', 'What data retention and deletion policies are implemented?', false, '2025-12-17 11:07:48.429276'),
('81', 'Security & Access', 'How are privileged actions logged and reviewed?', false, '2025-12-17 11:07:48.666364'),
('121', 'Product Features', 'What are the main features provided by the direct equity unit balance display in the wealth management system?', false, '2025-12-17 11:54:51.776712'),
('122', 'Product Features', 'How does the unrealized gain/loss calculation work in the direct equity security currency for wealth management?', false, '2025-12-17 11:54:52.028251'),
('123', 'Risk Management', 'What methods are employed to assess cloud infrastructure risks in wealth management?', false, '2025-12-17 11:54:52.269621'),
('124', 'Risk Management', 'How does the organization manage defects & security vulnerabilities within its wealth management system?', false, '2025-12-17 11:54:52.512156'),
('125', 'Investment Strategies', 'What types of model portfolios are maintained for wealth management?', false, '2025-12-17 11:54:52.754474'),
('126', 'Investment Strategies', 'How is risk appetite mapped in developing wealth management strategies?', false, '2025-12-17 11:54:52.997025'),
('127', 'Client Onboarding', 'What are the key steps involved in the customer onboarding process via the wealth management system?', false, '2025-12-17 11:54:53.238386'),
('128', 'Client Onboarding', 'What types of client category questionnaires are used during wealth management onboarding?', false, '2025-12-17 11:54:53.480687'),
('129', 'Fee Structure', 'How is the fee structure determined for asset management within the wealth management system?', false, '2025-12-17 11:54:53.722449'),
('130', 'Fee Structure', 'What fees are associated with advisory services in wealth management?', false, '2025-12-17 11:54:53.963607'),
('131', 'Performance Tracking', 'What metrics are used to track the performance of direct equity holdings in wealth management?', false, '2025-12-17 11:54:54.205995'),
('132', 'Performance Tracking', 'How is the weighted average cost of direct equity tracked and displayed in wealth management?', false, '2025-12-17 11:54:54.448862'),
('133', 'Regulatory Compliance', 'How does the compliance risk management framework operate within wealth management?', false, '2025-12-17 11:54:54.690453'),
('134', 'Regulatory Compliance', 'What procedures are in place for monitoring regulatory compliance risks for wealth management products?', false, '2025-12-17 11:54:54.932464'),
('135', 'Technology Integration', 'How does the wealth management system handle integrations with external trading platforms?', false, '2025-12-17 11:54:55.175336'),
('136', 'Technology Integration', 'What is the process for capturing trade data executed outside the wealth management system?', false, '2025-12-17 11:54:55.417482'),
('137', 'Customer Service', 'How are customer inquiries and service requests managed within the wealth management portal?', false, '2025-12-17 11:54:55.659636'),
('138', 'Customer Service', 'What are the methods for managing customer service management risks in wealth management?', false, '2025-12-17 11:54:55.900947'),
('139', 'Market Trends', 'What impact do market currency fluctuations have on wealth management decisions?', false, '2025-12-17 11:54:56.142709'),
('140', 'Market Trends', 'How are global tax regimes affecting the wealth management market?', false, '2025-12-17 11:54:56.386417'),
('141', 'Competitive Analysis', 'What are the key factors considered in the competitive analysis for the wealth management industry?', false, '2025-12-17 11:54:56.627447'),
('142', 'Competitive Analysis', 'How does the wealth management product distinguish itself from similar offerings by competitors?', false, '2025-12-17 11:54:56.869721'),
('143', 'Portfolio Diversification', 'How is portfolio diversification achieved in wealth management strategies?', false, '2025-12-17 11:54:57.114214'),
('144', 'Portfolio Diversification', 'What role do alternative investments play in the diversification of wealth management portfolios?', false, '2025-12-17 11:54:57.356832'),
('145', 'Product Features', 'How does the realized gain/loss data display assist clients in wealth management decision-making?', false, '2025-12-17 11:54:57.599562'),
('146', 'Product Features', 'What detailed view options are provided for wealth management account summaries?', false, '2025-12-17 11:54:57.842064'),
('147', 'Risk Management', 'What strategies are implemented for mitigating liquidity risks in wealth management?', false, '2025-12-17 11:54:58.086441'),
('148', 'Risk Management', 'How does the BELIEF framework support enterprise risk management in wealth management?', false, '2025-12-17 11:54:58.328128'),
('149', 'Investment Strategies', 'What is the role of the risk profile questionnaire in shaping client investment strategies?', false, '2025-12-17 11:54:58.570517'),
('150', 'Investment Strategies', 'How do personal investment objectives influence wealth management strategies for clients?', false, '2025-12-17 11:54:58.812228'),
('151', 'Client Onboarding', 'What systems are used to validate client identities during the onboarding process in wealth management?', false, '2025-12-17 11:54:59.053487'),
('152', 'Client Onboarding', 'What steps are involved in creating customer management profiles within the wealth management system?', false, '2025-12-17 11:54:59.297837'),
('153', 'Fee Structure', 'What are the industry standards for performance fees in private wealth management?', false, '2025-12-17 11:54:59.539717'),
('154', 'Fee Structure', 'How are custody and administration fees calculated in wealth management?', false, '2025-12-17 11:54:59.78184'),
('155', 'Performance Tracking', 'What tools are available for clients to view the performance of their investment accounts in wealth management?', false, '2025-12-17 11:55:00.023661'),
('156', 'Performance Tracking', 'How is investment account performance evaluated against benchmark indices in wealth management?', false, '2025-12-17 11:55:00.267378'),
('157', 'Regulatory Compliance', 'What compliance checks are integrated into the wealth management processes?', false, '2025-12-17 11:55:00.50838'),
('158', 'Regulatory Compliance', 'How are changes in regulatory environments incorporated into the risk management strategies?', false, '2025-12-17 11:55:00.749632'),
('159', 'Technology Integration', 'What is the onboarding process for new technology partners in the wealth management ecosystem?', false, '2025-12-17 11:55:00.990866'),
('160', 'Technology Integration', 'How is secure data transmission ensured in external platform integrations for wealth management?', false, '2025-12-17 11:55:01.233389'),
('161', 'Customer Service', 'What processes are in place to measure customer satisfaction in wealth management services?', false, '2025-12-17 11:55:01.475948'),
('162', 'Customer Service', 'How do customer service dashboards contribute to effective wealth management operations?', false, '2025-12-17 11:55:01.718399'),
('163', 'Market Trends', 'How do social and economic risks influence wealth management strategies?', false, '2025-12-17 11:55:01.962476'),
('164', 'Market Trends', 'What competitive risks are most prevalent in the wealth management sector?', false, '2025-12-17 11:55:02.206771'),
('165', 'Competitive Analysis', 'How does the wealth management product address the needs of high-net-worth individuals?', false, '2025-12-17 11:55:02.453065'),
('166', 'Competitive Analysis', 'What are the primary competitive advantages of the current wealth management system?', false, '2025-12-17 11:55:02.75895'),
('167', 'Portfolio Diversification', 'What is the process for reassessing portfolio allocations in response to market changes?', false, '2025-12-17 11:55:03.001512'),
('168', 'Portfolio Diversification', 'How often is asset rebalancing recommended within wealth management portfolios?', false, '2025-12-17 11:55:03.24287'),
('169', 'Platform Vision & Value', 'Which business outcomes drive investment in this wealth platform?', true, '2025-12-17 19:57:01.989283'),
('170', 'Platform Vision & Value', 'How does the platform improve RM productivity and operating risk?', true, '2025-12-17 19:57:02.236919');

INSERT INTO public.ba_knowledge_questions (id, category, question, is_active, created_at) VALUES
('171', 'Functional Modules', 'How are RM dashboards, tools, and 360° portfolio views organized?', true, '2025-12-17 19:57:02.474689'),
('172', 'Functional Modules', 'How do model portfolios connect investments, execution, and reporting modules?', true, '2025-12-17 19:57:02.723982'),
('173', 'User Journeys', 'How does the journey differ for RM portal versus client portal orders?', true, '2025-12-17 19:57:02.95978'),
('174', 'User Journeys', 'What are the stages from order placement through settlement status updates?', true, '2025-12-17 19:57:03.196957'),
('175', 'Client Onboarding & KYC', 'How do KYC and account masters gate downstream investment actions?', true, '2025-12-17 19:57:03.444242'),
('176', 'Client Onboarding & KYC', 'How are joint accounts represented across base, account, and portfolio structures?', true, '2025-12-17 19:57:03.680841'),
('177', 'Suitability & Recommendations', 'How is model recommendation tuned by risk, goals, and AUM?', true, '2025-12-17 19:57:03.91652'),
('178', 'Suitability & Recommendations', 'How do suitability thresholds affect model visibility and ranking outcomes?', true, '2025-12-17 19:57:04.154878'),
('179', 'Portfolio Construction', 'How is a model decomposed into weighted underlying security orders?', true, '2025-12-17 19:57:04.39229'),
('180', 'Portfolio Construction', 'How are minimum investments and multiples enforced after allocation?', true, '2025-12-17 19:57:04.62844'),
('181', 'Rebalancing', 'What triggers rebalancing, and who can initiate it?', true, '2025-12-17 19:57:04.86712'),
('182', 'Rebalancing', 'How does client opt-in for auto-rebalance change execution controls?', true, '2025-12-17 19:57:05.104533'),
('183', 'Orders & Transactions', 'How does one model order generate many client-level orders?', true, '2025-12-17 19:57:05.341663'),
('184', 'Orders & Transactions', 'How are Lumpsum, SIP, and SWP handled differently in validations?', true, '2025-12-17 19:57:05.57772'),
('185', 'Order Lifecycle', 'How do cut-off rules alter NAV date and client communication?', true, '2025-12-17 19:57:05.814593'),
('186', 'Order Lifecycle', 'How is the model order unique ID created, used, and expired?', true, '2025-12-17 19:57:06.050374'),
('187', 'Payments & Settlement', 'How does payment routing differ between consolidated and security-level debits?', true, '2025-12-17 19:57:06.286837'),
('188', 'Payments & Settlement', 'How do payment retries work across retries, grace windows, and references?', true, '2025-12-17 19:57:06.526482'),
('189', 'Data Model & Entities', 'How do customer, account, portfolio, model, and holdings relate end-to-end?', true, '2025-12-17 19:57:06.761547'),
('190', 'Data Model & Entities', 'How do portfolio architecture types handle goals and folios differently?', true, '2025-12-17 19:57:06.997826'),
('191', 'Data Model & Entities', 'How is a goal-linked portfolio represented when folios are absent?', true, '2025-12-17 19:57:07.346802'),
('192', 'Business Rules & Validations', 'Which fields are mandatory, and how is missing data handled?', true, '2025-12-17 19:57:07.584665'),
('193', 'Business Rules & Validations', 'How does model status and channel eligibility prevent invalid orders?', true, '2025-12-17 19:57:07.819918'),
('194', 'Business Rules & Validations', 'How are lock-in and ELSS restrictions enforced during redemption or switch?', true, '2025-12-17 19:57:08.062323'),
('195', 'Workflow & Approvals', 'How is maker-checker approval configured at order versus SIP setup?', true, '2025-12-17 19:57:08.298242'),
('196', 'Workflow & Approvals', 'How do multi-level approvals affect turnaround time and audit readiness?', true, '2025-12-17 19:57:08.534531'),
('197', 'Exception Handling & Overrides', 'How are soft-stop warnings versus hard-stop blocks configured and justified?', true, '2025-12-17 19:57:08.772031'),
('198', 'Exception Handling & Overrides', 'How are common error cases surfaced to users and operations teams?', true, '2025-12-17 19:57:09.011755'),
('199', 'Integrations & APIs', 'Which services orchestrate model order initiation, consent, and payment updates?', true, '2025-12-17 19:57:09.247859'),
('200', 'Integrations & APIs', 'How does reverse feed from execution processors update settlement statuses?', true, '2025-12-17 19:57:09.48481'),
('201', 'Integrations & APIs', 'How are adapters chosen between API, files, and database connectors?', true, '2025-12-17 19:57:09.720347'),
('202', 'External Dependencies', 'Which upstream dependencies must be ready before placing model orders?', true, '2025-12-17 19:57:09.956064'),
('203', 'External Dependencies', 'How do RTA/BSE STAR integrations shape order routing and confirmations?', true, '2025-12-17 19:57:10.192611'),
('204', 'Security & Identity', 'How do SSO, OAuth tokens, and RBAC combine across channels?', true, '2025-12-17 19:57:10.427929'),
('205', 'Security & Identity', 'How is least-privilege enforced across services, databases, and admin consoles?', true, '2025-12-17 19:57:10.665495'),
('206', 'Security & Identity', 'How does segregation-of-duties prevent toxic permission combinations?', true, '2025-12-17 19:57:10.902588'),
('207', 'Audit & Logging', 'Which events are audited for immutability across orders, payments, and access?', true, '2025-12-17 19:57:11.139652'),
('208', 'Audit & Logging', 'How are PII and credentials masked in logs and reports?', true, '2025-12-17 19:57:11.3767'),
('209', 'Compliance & Regulatory', 'How are SEBI nominee changes reflected in workflows and validations?', true, '2025-12-17 19:57:11.616466'),
('210', 'Compliance & Regulatory', 'How do retention and purging policies align with regulatory timelines?', true, '2025-12-17 19:57:11.852565'),
('211', 'Operations & Monitoring', 'How are runbooks structured for incidents, scaling, access, and backups?', true, '2025-12-17 19:57:12.088407'),
('212', 'Operations & Monitoring', 'How is service dependency mapping used for impact analysis during outages?', true, '2025-12-17 19:57:12.324231'),
('213', 'Scalability & Performance', 'How do microservices scale independently under variable order volumes?', true, '2025-12-17 19:57:12.561797'),
('214', 'Scalability & Performance', 'How do CQRS, sharding, or partitioning decisions affect reporting latency?', true, '2025-12-17 19:57:12.797548'),
('215', 'Configurability & Extensibility', 'Which platform behaviors are configurable without code changes, and why?', true, '2025-12-17 19:57:13.033302'),
('216', 'Configurability & Extensibility', 'How are API versions managed to avoid breaking external integrations?', true, '2025-12-17 19:57:13.269467'),
('217', 'Risks & Edge Cases', 'What happens when unique IDs expire mid-journey or payments fail?', true, '2025-12-17 19:57:13.505966'),
('218', 'Risks & Edge Cases', 'Which assumptions about data granularity and reconciliation create delivery risk?', true, '2025-12-17 19:57:13.741755');
